        ...
        <section className="mt-20 scroll-mt-20 pb-40 px-4 bg-gradient-to-b from-transparent via-brand-dark/[0.2] to-transparent dark:via-brand-dark/[0.4]" id="technology">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative rounded-xl border border-brand-light/10 dark:border-brand-dark/10 bg-brand-light/5 dark:bg-brand-dark/5 backdrop-blur-sm transition-all duration-300 hover:border-brand-primary/20 hover:bg-brand-primary/[0.02] group">
