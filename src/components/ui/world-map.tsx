  ...
  return (
    <div className="w-full aspect-[2/1] relative font-sans">
      ...
      <svg
        ref={svgRef}
        viewBox="0 0 800 400"
        className="w-full h-full absolute inset-0 pointer-events-none select-none [mask-image:linear-gradient(to_bottom,transparent_0%,white_25%,white_75%,transparent_100%)]"
      >
        {dots.map((dot, i) => {
